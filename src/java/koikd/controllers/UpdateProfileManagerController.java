...
@MultipartConfig // có dòng này mới up tham số kiểu ảnh được
@WebServlet(name = "UpdateProfileManagerController", urlPatterns = {"/UpdateProfileManagerController"})
public class UpdateProfileManagerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            EmployeesDTO employee = (EmployeesDTO) session.getAttribute("LOGIN_MANAGER");
            ...
            if (email != null) {
                ...
                EmployeesDAO  manager = new EmployeesDAO();
                boolean isUpdate = manager.updateDeliveryProfile(firstName, lastName, email, custAddress);
                ...
                if (isUpdate) {
                    ...
                    session.setAttribute("LOGIN_MANAGER", employee);
            ...
            Logger.getLogger(UpdateProfileManagerController.class.getName()).log(Level.SEVERE, null, ex);
