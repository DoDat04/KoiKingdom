 ...
 * @author Do Dat
 */
@WebServlet(name = "GetTourBookingDetailListController", urlPatterns = {"/tour-booking-detail-list"})
public class GetTourBookingDetailListController extends HttpServlet {
    private static final String TOUR_BOOKING_DETAIL_PAGE = "tourBookingDetailList.jsp";
    /**
