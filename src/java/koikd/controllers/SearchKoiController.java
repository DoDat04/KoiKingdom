 ...
 */
@WebServlet(name = "SearchKoiController", urlPatterns = {"/searchkoi"})
public class SearchKoiController extends HttpServlet {
    private static final String SEARCH_PAGE = "manageKoi.jsp";
    private static final String SEARCH_RESULT = "searchKoi.jsp";
    /**
        ...
        String url = SEARCH_PAGE;
         try {
            ...
            if (searchValue == null || searchValue.trim().isEmpty()) {
                ...
                List<KoiDTO> result = dao.searchKoi(searchValue,pageIndex);
                if (result != null && !result.isEmpty()) {
                    url = SEARCH_RESULT;
                    request.setAttribute("SEARCH_KOI", result);
