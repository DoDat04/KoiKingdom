 ...
 * @author ADMIN LAM
 */
@WebServlet(name = "UpdateProfileSalesController", urlPatterns = {"/update-profile-sales"})
@MultipartConfig
public class UpdateProfileSalesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            EmployeesDTO employee = (EmployeesDTO) session.getAttribute("LOGIN_SALES");
            ...
            if (email != null) {
                ...
                if (isUpdate) {
                    ...
                    session.setAttribute("LOGIN_SALES", employee);
                    session.setAttribute("updateSuccessSales", "Update successfully!");
                } else {
