 ...
 * @author Do Dat
 */
@WebServlet(name = "UpdateTourBookingCustomStatusController", urlPatterns = {"/update-status-customTour"})
public class UpdateTourBookingCustomStatusController extends HttpServlet {
    private static final String TOUR_BOOKING_DETAIL_PAGE = "tourCustomList.jsp";
    /**
