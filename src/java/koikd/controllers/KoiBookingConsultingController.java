 ...
 * @author Do Dat
 */
@WebServlet(name = "KoiBookingConsultingController", urlPatterns = {"/koi-booking-list"})
public class KoiBookingConsultingController extends HttpServlet {
    private static final String KOI_BOOKING_LIST = "KoiBookingOnline.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<KoiOrderDTO> dto = dao.getKoiBookingForConsulting();
            request.setAttribute("KOIBOOKINGLIST", dto);
