...
public class UpdateProfileDeliveryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            EmployeesDTO employee = (EmployeesDTO) session.getAttribute("LOGIN_DELIVERY");
            ...
            if (email != null) {
                ...
                if (isUpdate) {
                    ...
                    session.setAttribute("LOGIN_DELIVERY", employee);
                    session.setAttribute("updateSuccessDelivery", "Update successfully!");
                } else {
