<%-- 
    Document   : koiOrderList
    Created on : Oct 30, 2024, 12:20:13 AM
    Author     : Do Dat
--%>
...
<html>
    ...
    <body>
        ...
        <div style="margin-top: 25vh; margin-left: 17%;" class="main-content"> 
            <h2 style="text-align: center; color: #4CAF50; font-weight: bold;">Koi Order</h2>
            <table class="table table-bordered" style="width: 100%; text-align: center; margin-top: 20px;">
                ...
                <tbody>
                    <c:forEach var="farm" items="${requestScope.KOIORDERLIST}">
                        <tr>
                            <td>${farm.koiOrderID}</td>
                            <td>${farm.fullName}</td>
                            <td>${farm.deliveryDate}</td>
                            <td>
                                <form action="koi-order-list" method="post" style="display: inline;">
