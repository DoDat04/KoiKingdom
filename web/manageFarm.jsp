                    ...
                    <tbody>
                        <c:forEach var="farm" items="${farm}">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${farm.status}">
                                            <a class="status-active btn btn-success" href="updateStatusFarm?farmID=${farm.farmID}"
                                               onclick="return confirm('Are you sure you want to change the status?');">
                                                Active
                                            </a>
                                        </c:when>
                                        <c:otherwise>
                                            <a class="status-inactive btn btn-danger" href="updateStatusFarm?farmID=${farm.farmID}"
                                               onclick="return confirm('Are you sure you want to change the status?');">
                                                Inactive
                                            </a>
                                        </c:otherwise>
